...
from QLearningWithoutPretrainingStateElimination import *
from QLearningWithoutPretrainingAndRuntimeStateElimination import *
...
class ActualADM:
    ...
    def __init__(self, adm_algo, dataframe, knowledge, house_name, occupant_id, num_timeslots, num_zones):
        ...
        self.knowledge     = knowledge  # ["Full" or "Partial"]
    ...
    def get_best_hyper_params(self, zone_id):
        ...
        filename = str(parent_directory) + '\data\\hyperparameters\\' + str(self.adm_algo) + '-' + str(self.knowledge) + '_House-' + str(self.house_name) + '_Occupant-' + str(self.occupant_id)  + '_Zone-' + str(zone_id) + '.json'
    ...
    def get_clusters(self):
        ...
        if self.knowledge == "Full":
            ...
            self.dataframe = self.dataframe[self.dataframe['Day'] <= 15]
