...
class QLearningWithoutPretrainingStateElimination:
    ...
    def get_all_possible_states(self):
        ...
        for arrival_time in range(self.num_timeslots):
            for arrival_zone in range(self.num_zones):
                for stay_duration in range(400):
        ...
        for episode in range(self.num_episodes):
            ...
            for iteration in range(self.num_iterations):
                ...
                while True:  
                    ...
                    if valid_actions == []:
                        self.q_table[state + '_' + str(action)] -= 100
            ...
            print("episode", episode, "cost", self.model_inference()[0], "q-table-size", len(self.q_table), "cost", total_cost)
